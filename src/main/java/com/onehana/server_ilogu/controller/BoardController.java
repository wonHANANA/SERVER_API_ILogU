...
public class BoardController {
    ...
    public BaseResponse<Void> createBoard(@AuthenticationPrincipal UserDto userDto, @RequestPart BoardCreateRequest request,
    ...
    @PutMapping("/{boardId}")
    public BaseResponse<Void> modifyBoard(@AuthenticationPrincipal UserDto userDto, @PathVariable Long boardId,
